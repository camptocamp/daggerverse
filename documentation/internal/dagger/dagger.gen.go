...
// The `RedhatModuleID` scalar type represents an identifier for an object of type RedhatModule.
type RedhatModuleID string

// The `RedhatPackagesID` scalar type represents an identifier for an object of type RedhatPackages.
type RedhatPackagesID string
...
func (r *Hugo) Platform(ctx context.Context) (Platform, error) {
	if r.platform != nil {
		return *r.platform, nil
	}
	q := r.query.Select("platform")
...
// Load a RedhatModule from its ID.
func (r *Client) LoadRedhatModuleFromID(id RedhatModuleID) *RedhatModule {
	q := r.query.Select("loadRedhatModuleFromID")
	q = q.Arg("id", id)
...
// Load a RedhatPackages from its ID.
func (r *Client) LoadRedhatPackagesFromID(id RedhatPackagesID) *RedhatPackages {
	q := r.query.Select("loadRedhatPackagesFromID")
	q = q.Arg("id", id)

	return &RedhatPackages{
		query: q,
	}
}
...
func (r *Redhat) CaCertificates() *Directory {
	q := r.query.Select("caCertificates")
...
func (r *Redhat) Module(name string) *RedhatModule {
	q := r.query.Select("module")
	q = q.Arg("name", name)
...
func (r *Redhat) Packages(names []string) *RedhatPackages {
...
func (r *RedhatMinimalModule) Disabled(container *Container) *Container {
	assertNotNil("container", container)
	q := r.query.Select("disabled")
	q = q.Arg("container", container)
...
func (r *RedhatMinimalPackages) Removed(container *Container) *Container {
	assertNotNil("container", container)
	q := r.query.Select("removed")
	q = q.Arg("container", container)
...
func (r *RedhatModule) WithGraphQLQuery(q *querybuilder.Selection) *RedhatModule {
	return &RedhatModule{
		query: q,
	}
}

func (r *RedhatModule) Disabled(container *Container) *Container {
	assertNotNil("container", container)
	q := r.query.Select("disabled")
	q = q.Arg("container", container)
...
func (r *RedhatModule) Enabled(container *Container) *Container {
	assertNotNil("container", container)
	q := r.query.Select("enabled")
	q = q.Arg("container", container)
...
// A unique identifier for this RedhatModule.
func (r *RedhatModule) ID(ctx context.Context) (RedhatModuleID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.query.Select("id")

	var response RedhatModuleID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *RedhatModule) XXX_GraphQLType() string {
	return "RedhatModule"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *RedhatModule) XXX_GraphQLIDType() string {
	return "RedhatModuleID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *RedhatModule) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *RedhatModule) UnmarshalJSON(bs []byte) error {
	...
	*r = *dag.LoadRedhatModuleFromID(RedhatModuleID(id))
	return nil
}

func (r *RedhatModule) Name(ctx context.Context) (string, error) {
	if r.name != nil {
		return *r.name, nil
	}
	q := r.query.Select("name")
...
func (r *RedhatPackages) WithGraphQLQuery(q *querybuilder.Selection) *RedhatPackages {
	return &RedhatPackages{
		query: q,
	}
}

// A unique identifier for this RedhatPackages.
func (r *RedhatPackages) ID(ctx context.Context) (RedhatPackagesID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.query.Select("id")

	var response RedhatPackagesID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *RedhatPackages) XXX_GraphQLType() string {
	return "RedhatPackages"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *RedhatPackages) XXX_GraphQLIDType() string {
	return "RedhatPackagesID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *RedhatPackages) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *RedhatPackages) UnmarshalJSON(bs []byte) error {
	...
	*r = *dag.LoadRedhatPackagesFromID(RedhatPackagesID(id))
	return nil
}

func (r *RedhatPackages) Installed(container *Container) *Container {
	assertNotNil("container", container)
	q := r.query.Select("installed")
	q = q.Arg("container", container)
...
func (r *RedhatPackages) Names(ctx context.Context) ([]string, error) {
	q := r.query.Select("names")
...
func (r *RedhatPackages) Removed(container *Container) *Container {
	assertNotNil("container", container)
	q := r.query.Select("removed")
	q = q.Arg("container", container)
