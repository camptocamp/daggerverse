...
import (
	...
	"dagger/redhat/internal/telemetry"
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "RedhatPackages":
		...
		case "Removed":
			...
			return (*RedhatPackages).Removed(&parent, container), nil
		default:
	...
	case "RedhatMinimalModule":
		...
		case "Disabled":
			...
			return (*RedhatMinimalModule).Disabled(&parent, container), nil
		default:
			return nil, fmt.Errorf("unknown function %s", fnName)
		}
	case "RedhatMinimalPackages":
		...
		case "Removed":
			...
			return (*RedhatMinimalPackages).Removed(&parent, container), nil
		default:
			return nil, fmt.Errorf("unknown function %s", fnName)
		}
	case "Redhat":
		...
		case "CaCertificates":
			...
			return (*Redhat).CaCertificates(&parent), nil
		case "Minimal":
			var parent Redhat
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
	...
	case "RedhatModule":
		...
		case "Disabled":
			...
			return (*RedhatModule).Disabled(&parent, container), nil
		default:
			return nil, fmt.Errorf("unknown function %s", fnName)
		}
	case "":
				...
				dag.TypeDef().WithObject("RedhatPackages").
					WithFunction(
						dag.Function("Installed",
							...
							WithArg("container", dag.TypeDef().WithObject("Container"))).
					WithFunction(
						dag.Function("Removed",
							dag.TypeDef().WithObject("Container")).
							WithArg("container", dag.TypeDef().WithObject("Container"))).
					WithField("Names", dag.TypeDef().WithListOf(dag.TypeDef().WithKind(StringKind)))).
			WithObject(
				dag.TypeDef().WithObject("RedhatMinimal").
					WithFunction(
						dag.Function("Container",
				...
				dag.TypeDef().WithObject("RedhatMinimalPackages").
					...
					WithFunction(
						dag.Function("Removed",
							dag.TypeDef().WithObject("Container")).
							WithArg("container", dag.TypeDef().WithObject("Container"))).
					WithField("Names", dag.TypeDef().WithListOf(dag.TypeDef().WithKind(StringKind)))), nil
	default:
