...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "Presentation":
		...
		case "Init":
			...
			return (*Presentation).Init(&parent, ctx), nil
		case "Builder":
			var parent Presentation
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*Presentation).Builder(&parent, ctx), nil
		case "Build":
			var parent Presentation
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*Presentation).Build(&parent, ctx), nil
		case "Server":
			var parent Presentation
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*Presentation).Server(&parent, ctx), nil
		case "":
			var parent Presentation
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return New(ctx, directory, npmrc)
		default:
				...
				dag.TypeDef().WithObject("Presentation").
					...
					WithConstructor(
						dag.Function("New",
							...
							WithArg("npmrc", dag.TypeDef().WithObject("Secret")))), nil
	default:
