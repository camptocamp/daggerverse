...
import (
	...
	"dagger/nodejs/internal/telemetry"
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "Nodejs":
		...
		case "Container":
			...
			return (*Nodejs).Container(&parent), nil
		case "":
			var parent Nodejs
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			WithObject(
				dag.TypeDef().WithObject("Nodejs").
					...
					WithConstructor(
						dag.Function("New",
							dag.TypeDef().WithObject("Nodejs")).
							WithArg("npmrc", dag.TypeDef().WithObject("Secret").WithOptional(true)))), nil
	default:
